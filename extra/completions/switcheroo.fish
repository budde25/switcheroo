...
complete -c switcheroo -n "__fish_switcheroo_needs_command" -f -a "gui" -d 'Opens the graphical user interface'
...
complete -c switcheroo -n "__fish_switcheroo_using_subcommand gui" -s v -l verbose -d 'Increase logging verbosity'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand gui" -s q -l quiet -d 'Decrease logging verbosity'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand gui" -s h -l help -d 'Print help'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "execute" -d 'Executes a payload on a connected Switch'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "device" -d 'Checks if a Switch is connected and booted to RCM mode'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "list" -d 'Lists favorite binaries'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "add" -d 'Add a favorite binary'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "remove" -d 'Remove a favorite binary'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "gui" -d 'Opens the graphical user interface'
complete -c switcheroo -n "__fish_switcheroo_using_subcommand help; and not __fish_seen_subcommand_from execute device list add remove gui help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
